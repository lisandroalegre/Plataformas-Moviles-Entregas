...
function enumerarLista(listaDePalabras) {
    const listaEnumerada = listaDePalabras.slice(0, -1).join(", ") + " y " + listaDePalabras[listaDePalabras.length - 1];
    return listaEnumerada.charAt(0).toUpperCase() + listaEnumerada.slice(1) + ".";
}

console.log("enumerarLista(['Han', 'Leia', 'Luke', 'Yoda']): ", enumerarLista(['Han', 'Leia', 'Luke', 'Yoda']));